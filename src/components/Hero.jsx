  ...
  return (
    <>
      <Container className="relative pt-20 pb-16 text-center lg:pt-32">
        ...
        <h1 className="mx-auto mt-28 font-display text-xl sm:text-4xl font-medium tracking-tight text-slate-900 ">
          <span className="relative whitespace-nowrap text-white">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-1/2 -translate-x-1/2 w-full h-[0.58em] fill-blue-500/70"
        ...
        <p className="mx-auto mt-12 max-w-2xl text-lg sm:text-xl tracking-tight text-white font-medium">
