  ...
  return (
    <>
      <Container className="relative pt-20 pb-16 text-center lg:pt-32">
        <div className="absolute top-0 left-1/2 -z-10 h-full w-full -translate-x-1/2 rounded-xl">
          <Image src={header} layout="fill" objectFit="cover" />
        </div>
        <h1 className="mx-auto mt-14 max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          <span className="relative whitespace-nowrap text-white">
            ...
            <span className="relative">The Orchard Holiday Home</span>
          </span>{" "}
        </h1>
        <p className="mx-auto mt-12 max-w-2xl text-xl tracking-tight text-white font-medium">
