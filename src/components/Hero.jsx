  ...
  return (
    <>
      <Container className="relative pt-20 pb-16 text-center lg:pt-32">
        ...
        <h1 className="mx-auto mt-14 max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">The Orchard</span>
          </span>{" "}
        </h1>
        <p className="mx-auto mt-12 max-w-2xl text-lg tracking-tight text-slate-700">
